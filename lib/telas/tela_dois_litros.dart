...
class _TelaDoisLitrosState extends State<TelaDoisLitros> {
  ...
  void _calcularTotal(int pacotesPorPalete) {
    ...
    // 1 pacote = 6 unidades
    final total = (paletes * pacotesPorPalete * 6) + (pacotes * 6) + unidades;
  ...
  void initState() {
    ...
    _controladorPaletes.addListener(() => _calcularTotal(configuracao.pacotesPorPalete2Litros));
    _controladorPacotes.addListener(() => _calcularTotal(configuracao.pacotesPorPalete2Litros));
    _controladorUnidades.addListener(() => _calcularTotal(configuracao.pacotesPorPalete2Litros));
  }
              ...
              children: [
                TextField(
                  ...
                  decoration: InputDecoration(
                    labelText: 'Paletes (1 palete = ${configuracao.pacotesPorPalete2Litros} pacotes)',
                  ),
